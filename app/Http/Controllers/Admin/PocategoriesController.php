...
use App\Models\Pocategories;

class PocategoriesController extends Controller
{
    /**
    ...
    {
        $category = Pocategories::orderBy('id','desc')->get();
    ...
    {
        $category = Pocategories::findOrFail($id);
